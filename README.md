...
![The NexBot desk](docs/screenshots/hero.png)

New to the installed app? Start with [`docs/getting-started.md`](docs/getting-started.md).
...
| Windows Electron shell | NSIS installer + portable exe |
| macOS Electron shell | arm64 DMG + zip (in-app updates need a signed build) |
