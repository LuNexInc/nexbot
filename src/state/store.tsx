...
import type { Color, Expression, Motion } from "@/lib/mascot";

export type { Color } from "@/lib/mascot";
...
type Action =
  ...
  | { type: "previewMascotMotion"; botId: string; kind: Exclude<Motion, "none"> }
  | {
      type: "updateBot";
      botId: string;
      patch: Partial<
