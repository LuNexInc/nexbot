...
export type Color = (typeof MAUS_COLOR_NAMES)[number];

export const MAUS_COLORS: Record<Color, string> = {
  green: "#009957",
  blue: "#377FE6",
  red: "#D94B52",
  orange: "#E78531",
...
export type Expression = (typeof MAUS_EXPRESSIONS)[number];
...
export type Motion = "none" | (typeof MAUS_MOTIONS)[number];
...
export type MascotBotProfile = {
  ...
  title?: string;
  description?: string;
  mascotExpression?: Expression | null;
  busy?: boolean;
  unread?: boolean;
 ...
 */
export function expressionForBot(bot: MascotBotProfile): Expression {
