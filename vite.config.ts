...
// Single source of truth for the app version: package.json at build time.
...
export default defineConfig({
  ...
  server: {
    ...
    // talks to /api — clients hold no transports. changeOrigin so the
    // live 0.3.8 harness on :8799 accepts the Vite-origin preview.
    proxy: {
      "/api": {
